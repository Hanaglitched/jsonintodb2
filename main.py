...
#     sql_set = "INSERT INTO MAGICNOTIFY_SET_INFO (`set`, `setName`, `reldate`) VALUES " + val_set + ";"
...
for i in range(0, len(_df.index)):
    ...
    if val != "":
        ...
        sql = "INSERT INTO MAGICNOTIFY_CARD_INFO (`koname`, `name`, `cardkingdom`, `cardkingdomfoil`, `set`, `setName`, `relDate`, `rarity`, `uuid`) VALUES " + val + ";"
        cursor.execute(sql)
connection.commit()
